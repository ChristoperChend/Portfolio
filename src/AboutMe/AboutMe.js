...
function AboutMe() {
    return <section className="mt-28 mx-14 flex flex-col justify-center lg:mx-24 xl:mx-40 xl:block">
        <div className="gap-x-10 flex flex-row lg:gap-x-14 xl:gap-x-16">
            ...
            <div className="font-jetBrains space-y-3 md:mt-5 xl:space-y-7 xl:mt-2">
                <h1 className="text-xl font-bold lg:text-3xl lg:mt-10 xl:text-5xl">About Me</h1>
